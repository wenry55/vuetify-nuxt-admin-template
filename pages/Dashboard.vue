        ...
        <material-card color="orange" full-header>
          <template #heading>
            <div class="pa-8 white--text">
              <div class="text-h4 font-weight-light">Employees Stats</div>
...
export default {
  ...
  components: {
        MaterialChartCard: () =>
      import(
        /* webpackChunkName: "material-chart-card" */
        '@/components/MaterialChartCard.vue'
      ),
    MaterialCard: () =>
      import(
        /* webpackChunkName: "material-card" */
        '@/components/MaterialCard.vue'
      ),
    MaterialStatCard: () =>
      import(
        /* webpackChunkName: "material-stat-card" */
        '@/components/MaterialStatCard.vue'
      ),
  },
